...
namespace FX {
    ...
    public:
        ...
        GraphicsCamera(const GraphicsCamera& other);
        GraphicsCamera(GraphicsCamera&& other) noexcept;
        GraphicsCamera& operator=(const GraphicsCamera& other);
        GraphicsCamera& operator=(GraphicsCamera&& other);

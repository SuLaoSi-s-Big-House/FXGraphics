...
namespace FX {
    ...
    public:
        ...
        void setField(float left, float right, float bottom, float top, float near, float far);
        void setField(float fov, float ratio, float near, float far);
    ...
    protected:
        ...
        // ortho
        vec4f m_extent = { -400, 400, -300, 300 };
